    ...
    private class GlassButton extends CButton {
        ...
        public void paint(Graphics g) {
            ...
            if (this.pressed || this.selected) {
                ...
                g2.drawRoundRect(0, 0, buttonWidth, buttonHeight, arc, arc);
            } else {
                ...
                int highlightHeight = buttonHeight * 1 / 2;
                ...
                gb.setColor(canvas.getColor());
                gb.setClip(new RoundRectangle2D.Float(0, 0, highlightWidth, highlightHeight, highlightArc, highlightArc));
                gb.fillRoundRect(0, 0, buttonWidth, buttonHeight, arc, arc);
