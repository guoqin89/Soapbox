...
public class CPopupMenu extends JPopupMenu implements ActionListener {
    ...
    CPopupMenu() {
        ...
        this.removeAll();
        this.setBorder(BorderFactory.createMatteBorder(8, 8, 8, 8, CGraphite.blue));
    ...
    public void setZoomLevel(double zoom) {
        ...
        view.setPreferredSize(new Dimension((int) (200 * this.zoom), (int) (items * ITEM_HEIGHT * this.zoom)));
        this.setPopupSize((int) (200 * this.zoom), (int) (Math.min(items * ITEM_HEIGHT + 10, 100) * this.zoom));
    }
